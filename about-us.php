...
<body>
    ...
    <div class="overflow-hidden overflow-hidden bg-smoke space" id="about-sec"
        data-bg-src="assets/img/bg/about-5-bg.png">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-6">
                    ...
                    <a href="./about-us.php" class="th-btn mt-40">ABOUT MORE<i
            ...
            <div class="row">
                <div class="col-lg-6 mb-30 mb-lg-0">
                    <div class="cta-card" data-bg-src="assets/img/bg/cta-bg_3_1.png">
                        ...
                        <a href="contact-us.php" class="th-btn style8">Join With Us<i
            ...
            <div class="row slider-shadow th-carousel blog-slider-1" data-slide-show="3" data-lg-slide-show="2"
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="th-blog blog-single style2">
                        <div class="blog-img">
                            <a href="#"><img src="assets/img/blog/blog-1-1.jpg" alt="Blog Image" /></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="#"><i class="fa-light fa-user"></i>by David Smith</a>
                                <a href="#"><i class="fa-light fa-clock"></i>05 Jun, 2023</a>
                            </div>
                            <h4 class="box-title">
                                <a href="#">Educate, Empower, Excel: Discover the Power of Learning!</a>
                            </h4>
                            <a href="#" class="link-btn">Read More Details<i class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-4">
                    <div class="th-blog blog-single style2">
                        <div class="blog-img">
                            <a href="#"><img src="assets/img/blog/blog-1-2.jpg" alt="Blog Image" /></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="#"><i class="fa-light fa-user"></i>by David Smith</a>
                            ...
                            <h4 class="box-title">
                                <a href="#">Enrich Your Mind, Envision Your Future: Education for
                                    Success</a>
                            </h4>
                            <a href="#" class="link-btn">Read More Details<i class="fas fa-arrow-right ms-2"></i></a>
                        </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="th-blog blog-single style2">
                        <div class="blog-img">
                            <a href="#"><img src="assets/img/blog/blog-1-3.jpg" alt="Blog Image" /></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="#"><i class="fa-light fa-user"></i>by David Smith</a>
                            ...
                            <h4 class="box-title">
                                <a href="#">University class starting soon while the lovely valley team
                                    work</a>
                            </h4>
                            <a href="#" class="link-btn">Read More Details<i class="fas fa-arrow-right ms-2"></i></a>
                        </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-8">
                    <div class="cta-wrap title-area mb-0">
                        ...
                        <a href="./about-us.php" class="th-btn style8">Join With Us<i
