    ...
    <div class="breadcumb-wrapper" data-bg-src="assets/img/bg/breadcumb-bg.jpg" data-overlay="title" data-opacity="8">
        ...
        <div class="container">
            <div class="breadcumb-content text-center">
                <h1 class="breadcumb-title">Apply for Course</h1>
                <ul class="breadcumb-menu">
                    <li><a href="index.php">Home</a></li>
                    <li>Apply for Course</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xl-5 mb-30 mb-xl-0">
                    <div class="me-xxl-5 mt-60">
                        ...
                        <p class="mt-n2 mb-25">
                            Unlock your potential with our expertly designed course tailored for students looking to
                            excel in techsolit academy. Whether you're aiming for academic success, personal growth, or
                            career advancement, this course is your pathway to success.
                        </p>
                ...
                <div class="col-xl-7">
                    <div class="contact-form-wrap" data-bg-src="assets/img/bg/contact_bg_1.png">
                        ...
                        <p class="mt-n1 mb-30 sec-text">
                            Take the first step toward achieving your goals. Click below to apply now and secure your
                            spot in techsolit academy.
                        </p>
