...
<body>
    ...
    <div class="breadcumb-wrapper" data-bg-src="assets/img/bg/breadcumb-bg.jpg" data-overlay="title" data-opacity="8">
        ...
        <div class="container">
            <div class="breadcumb-content text-center">
                <h1 class="breadcumb-title">SAP BASIS </h1>
        ...
        <div class="container">
            <div class="breadcumb-content text-center">
                ...
                <div class="bread-icon">
                    <div class="in"><i class="fa-solid fa-clock"></i> <span>40-45 Hours</span> Hours</div>
    ...
    <a href="./contact-us.php">
        <img src="./assets/img-iq/java11.jpg" alt="Event Image" />
                        ...
                        <div class="col-lg-12">
                            <div class="">
                                <h4 class="h4 mb-25">What is meant by SAP BASIS Training?</h4>
                                <p class="mb-30">
                                        SAP Basis is the SAP version of system administration. SAP Basis administrators are responsible
                                        for making sure that the SAP application server and applications are installed and configured 
                                        properly; they also maintain the whole landscape and its smooth operation. SAP Basis is the 
                                        technical foundation that enables all SAP applications to function smoothly. It consists of 
                                        programs and tools that support the interactions of multiple systems and the portability of SAP 
                                ...
                                <p class="mb-30">
                                    ...
                                    Anyone interested in learning and building a career with SAP BASIS skills can take up this online Course.
                                </p>


                                <h4 class="h4 mb-25">What are the benefits of SAP BASIS Certification Training? </h4>
                                <p>
                                    The SAP BASIS Certification makes you skilled in using the SAP BASIS application in real-time to manage 
                                    various activities. It also separates you from your peer learners who are non-certified and helps you 
                                    explore many job opportunities. 
                                </p>


                                <!--
                                <h4 class="h4 mb-25">
                                    Do we provide placement support to the learners of SAP BASIS?
                                ...
                                <ul>
                                    ...
                                    <li>Our expert instructor will ensure that you learn and understand all the SAP BASIS concepts from day one of the Course.</li>
                                    ...
                                    <li>Further, our hands-on Training and real-time projects, along with practice exercises, will help you gain expertise in the BASIS module.</li>
                                ...
                                <h4 class="h4 mb-25">
                                What job roles will be there after SAP BASIS Online Training?
                                </h4>
                                <li>SAP BASIS Consultant</li>
                                <li>SAP BASIS Administrator</li>
                                <li>SAP BASIS Support Specialist</li>
                                <li>SAP BASIS Functional Consultant</li>
                                <li>SAP BASIS Engineer</li>
                                <li>SAP Landscape Administrator</li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">SAP Basis Overview</h4>
                        <div class="checklist">
                            <ul>
                                <li>My SAP Business Suite and my SAP ERP</li>
                                <li>Definition of SAP NetWeaver</li>
                                <li>The SAP Release Strategy</li>
                                <li>Introduction To SAP R/3</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">Basics</h4>
                        <div class="checklist">
                            <ul>
                                <li>What Is an SAP System?</li>
                                <li>ERP</li>
                                <li>Hardware requirement of ERP(OS & DATABASE )</li>
                                <li>Configuring SAP Logon</li>
                                <li>Versions</li>
                                <li>Analysis Transactions</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">Significance of SAP Service Market Place <br>
                                            Planning the Installation of SAP ERP Component</h4>
                        <!-- <div class="checklist">
                            <ul>
                                <li>What Is an SAP System?</li>
                                <li>ERP</li>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">Installation and post Installation</h4>
                        <div class="checklist">
                            <ul>
                                <li>ASAP Methodology</li>
                                <li>Planning and the preparation for Installation</li>
                                <li>Installation on Windows</li>
                                <li>Hardware Sizing</li>
                                <li>Installing and Patching Oracle Database Software</li>
                                <li>Central Instance Installation</li>
                                <li>Database Instance Installation</li>
                                <li>Dialog Instance Installation</li>
                                <li>Troubleshooting of Installation Problems</li>
                                <li>Post-Installation Activities of ERP Component</li>
                                <li>SAP GUI Installation and installing the GUI Patches</li>
                                <li>Starting and Stopping the SAP System</li>
                                <li>System Start Process</li>
                                <li>Log tracing techniques in SAP and OS</li>
                                <li>System Shutdown and Startup process and analysis</li>
                                <li>Starting and Stopping SAP under Windows and UNIX Operating Systems</li>
                                <li>SPAM/SAINT Upgrade</li>
                                <li>How to download the patches and applying Patches, Support Packages from Service Market Place.</li>
                                <li>Sgen Whole system fragmentation</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">SAP Note AND Patches</h4>
                        <div class="checklist">
                            <ul>
                                <li>Applying Notes using SNOTE</li>
                                <li>Kernel Upgrade</li>
                                <li>Installation of Languages like Arabic, Chinese etc</li>
                                <li>Logon Screen Customizing of the SAP System</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">Client Administration</h4>
                        <div class="checklist">
                            <ul>
                                <li>Local Client Copy</li>
                                <li>Client Export Import</li>
                                <li>Remote Client Copy</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">Client Comparison and Maintenance Tools</h4>
                        <div class="checklist">
                            <ul>
                                <li>System Landscape</li>
                                <li>Single system landscape</li>
                                <li>Two system Landscape</li>
                                <li>Three system Landscape</li>
                                <li>Multi System Landscape</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">Transport Management System</h4>
                        <div class="checklist">
                            <ul>
                                <li>TMS Terminology And Concepts</li>
                                <li>Configuring TMS & Checking Transport Directory</li>
                                <li>Configuring Transport Domain Controller & Group</li>
                                <li>Configuring Virtual Sap System & Displaying Configuration</li>
                                <li>Including Sap Systems In The Transport Domain</li>
                                <li>Creating Consolidated Routes and Delivery Routes</li>
                                <li>Transport Directory Vs Transport Domain</li>
                                <li>Troubleshooting Transports</li>
                                <li>Cleaning Up the Transport Directory</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">Change and Transport System</h4>
                        <div class="checklist">
                            <ul>
                                <li>Customizing Request and Workbench Requests</li>
                                <li>Releasing Requests through Customizing/Workbench /Transport Organizer</li>
                                <li>Importing Change Requests</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">Support Activates</h4>
                        <div class="checklist">
                            <ul>
                                <li>Architecture of the SAP Web Application Server</li>
                                <li>Dispatcher Process</li>
                                <li>Message server</li>
                                <li>Work process Architecture</li>
                                <li>Dialog Work Process</li>
                                <li>Background Work Process</li>
                                <li>Update Work Process</li>
                                <li>Enqueue Work Process</li>
                                <li>Spool work Process</li>
                                <li>SAP Transactions</li>
                                <li>System Logs</li>
                                <li>Various Monitoring Techniques and Tcodes Working with ABAP Dumps</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">SAP Background Administration</h4>
                        <div class="checklist">
                            <ul>
                                <li>Fundamentals of Background Processing</li>
                                <li>Various types of Background Jobs</li>
                                <li>Scheduling the Background jobs</li>
                                <li>Monitoring the Background Jobs</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">SAP Spool Administration</h4>
                        <div class="checklist">
                            <ul>
                                <li>Overview of spool process</li>
                                <li>Configure and Troubleshoot SAP Printers</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">Profile Maintenance and Parameter Setting</h4>
                        <div class="checklist">
                            <ul>
                                <li>Default Profile</li>
                                <li>Start Profile</li>
                                <li>Instance Profile</li>
                                <li>Maintaining the parameter in instance profile</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">Operation Modes</h4>
                        <div class="checklist">
                            <ul>
                                <li>Define an Operation Mode Day And Night Operations</li>
                                <li>Manual Switching Of Modes</li>
                                <li>Exceptional Mode</li>
                                <li>Monitoring</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">CCMS</h4>
                        <div class="checklist">
                            <ul>
                                <li>Introduction to CCMS</li>
                                <li>CCMS Monitors</li>
                                <li>Alert Monitors</li>
                                <li>Analyzing Alerts and Performance & Tuning</li>
                                <li>System Monitoring with CCMS</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">Tools for SAP System Administration</h4>
                        <div class="checklist">
                            <ul>
                                <li>Daily Tasks in System Management</li>
                                <li>SAP Service Marketplace</li>
                                <li>SAP Developer Network</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">Setting up Remote Connections</h4>
                        <div class="checklist">
                            <ul>
                                <li>Fundamentals and Types of RFC</li>
                                <li>Setting up RFC Connections</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">Performance & Server Monitoring, Tuning and Troubleshooting</h4>
                        <div class="checklist">
                            <ul>
                                <li>Workload Analysis</li>
                                <li>Performance Analysis Monitors</li>
                                <li>SAP Memory Management</li>
                                <li>Hardware Capacity Verification</li>
                                <li>Expensive SQL Statements</li>
                                <li>SAP Table Buffering</li>
                ...
                <div class="col-lg-12">
                    <div class="event-details-wrap mt-4">
                        <h4 class="h4 mb-25">Security Administration</h4>
                        <div class="checklist">
                            <ul>
                                <li>User Administration</li>
                                <li>Creating and Maintaining User Master Records</li>
                                <li>Logon and Password Security</li>
                                <li>Super Users</li>
                                <li>Creating And Maintaining Single User's mass Users And User Groups</li>
                                <li>Copying Deleting Locking/Unlocking Users</li>
                                <li>Creation of Authorization Object</li>
                                <li>Creation of Authorization Class and maintaining the Authorization Profile</li>
                                <li>Create/Maintaining Authorization/Create/Maintaining Roles/Generating Profiles by Using PFCG</li>
                                <li>Creating Single and Composite Roles</li>
                                <li>Deriving and Comparing Roles</li>
                                <li>Transporting and Distributing Roles</li>
                                <li>Inserting Missing Authorizations</li>
                            </ul>
                        </div>
                    </div>
                </div>
